...
**Шард A1** - для работы с данными пользователей (users);

**Шард B1** - для работы с каталогом книг (books и связанные таблицы);

**Шард C1** -  для работы с данными магазинов (stores, filials).
